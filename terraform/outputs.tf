output azdo_project_id {
  ...
  value       = module.azure_service_connection.project_id
}
output azdo_service_connection_id {
  description = "The Azure DevOps service connection id"
  value       = module.azure_service_connection.service_connection_id
}
...
output azdo_service_connection_url {
  ...
  value       = module.azure_service_connection.service_connection_url
}
...
output identity_federation_subject {
  ...
  value       = module.azure_service_connection.service_connection_oidc_subject
}
output identity_issuer {
  description = "The federation issuer"
  value       = module.azure_service_connection.service_connection_oidc_issuer
}
